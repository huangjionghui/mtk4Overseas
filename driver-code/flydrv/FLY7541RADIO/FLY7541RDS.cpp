...
void UpdateRDS_PI(P_FLY_TDA7541_RADIO_INFO pTDA7541RadioInfo)
{
	...
	if(0 == pTDA7541RadioInfo->RDSInfo.BaseReferencePI)//确定基准PI
	{
		pTDA7541RadioInfo->RDSInfo.BaseReferencePI = temp;
	}
}
void printfRDS_PTY(P_FLY_TDA7541_RADIO_INFO pTDA7541RadioInfo)//20100427 节目类型
{
...
void printfRDS_PS(P_FLY_TDA7541_RADIO_INFO pTDA7541RadioInfo,BYTE *p)//20100427	 频道名称
{
	BYTE buff[9];
	BYTE i;
...
void printfRDS_TA(P_FLY_TDA7541_RADIO_INFO pTDA7541RadioInfo)	  //20100427 交通信息
{
...
void printfRDS_TA_Spec(P_FLY_TDA7541_RADIO_INFO pTDA7541RadioInfo)	  //20100427 交通信息
{
	BYTE buff[3] = {RADIORDS_ID_TA,0x00};
...
void rdsdec_prc_0x(P_FLY_TDA7541_RADIO_INFO pTDA7541RadioInfo,BYTE fab)
{
	...
	if(seg==3)// Build Complete
	{
		...
		if(fab==GROUP_A)
		{
			if(memcmp(pTDA7541RadioInfo->RDSInfo.rdsdec_af,sRDSTemp.rds_af,8))//且有变化
			{				
...
//  none
//=============================================================================
void rdsdec_prc_9x(P_FLY_TDA7541_RADIO_INFO pTDA7541RadioInfo,BYTE fab)	//EWS似乎有不同标准，ODA
{
}
...
//  none
//=============================================================================
void rdsdec_process(P_FLY_TDA7541_RADIO_INFO pTDA7541RadioInfo)//处理接收到的完整的一组数据
{
	...
	case 14: rdsdec_prc_14x_spec(pTDA7541RadioInfo,fab); break;//特别版，解TA信号
...
DWORD WINAPI TDA7541RadioRDSRecThread(LPVOID pContext)
{
	...
	while (!pTDA7541RadioInfo->bKillDispatchRDSRecThread)
	{
		...
		{
			rdsdec_process(pTDA7541RadioInfo);//处理接收到的完整的一组数据
		}
